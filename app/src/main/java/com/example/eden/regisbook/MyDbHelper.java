...
public class MyDbHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<ModelRecord> getAllRecords(String orderBy){
        ...
        String selectQuery = " SELECT * FROM " + Constants.TABLE_NAME + " ORDER BY " + orderBy;//ojo comillas separadas else error**
    ...
    public ArrayList<ModelRecord> searchRecords(String query){
        ...
        ArrayList<ModelRecord> recordsList = new ArrayList<>();
        // consulta para seleccionar registros
        String selectQuery = " SELECT * FROM " + Constants.TABLE_NAME + " WHERE " + Constants.C_NAME + " LIKE '%" + query +"%'";//ojo comillas separadas else error**
